...
NumericVector MVP_khatrirao_rcpp(const List& A_list, const NumericVector& x){
...
NumericVector MVP_khatrirao_trans_rcpp(const List& A_list, const NumericVector& y){
...
NumericVector diag_khatrirao_rcpp(const List& A_list){
